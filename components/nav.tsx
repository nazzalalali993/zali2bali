...
const NAV_LINKS = [
  { label: "Company", href: "/company" },
  {
    ...
    children: [
      ...
      { label: "Automation", href: "/solutions/automation", desc: "WhatsApp, Instagram, and website unified" },
      { label: "Web Development", href: "/solutions/web-development", desc: "Booking-enabled websites, built in" },
      { label: "GoHighLevel", href: "/solutions/gohighlevel", desc: "White-label CRM and workflow implementation" },
    ],
  },
